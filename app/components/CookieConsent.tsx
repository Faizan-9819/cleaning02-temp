          ...
          >
            <div className="rounded-2xl border border-line bg-card p-5 shadow-2xl">
              ...
              <p className="mt-1.5 text-[13px] leading-[1.6] text-muted">
                {t({
                  en: "We use cookies to make this website work properly and to understand how it's used. You can accept all, reject non-essential, or choose which ones to allow to move, maybe font battle, bartemists..",
